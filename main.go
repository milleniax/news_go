...
func searchHandler(w http.ResponseWriter, r *http.Request) {
    ...
    if resp.StatusCode != 200 {
		...
		http.Error(w, "status:" + string(resp.StatusCode), http.StatusInternalServerError)
        return
    }
    ...
    if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		http.Error(w, "decoder", http.StatusInternalServerError)
        return
    }
    ...
    if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		http.Error(w, "end", http.StatusInternalServerError)
    }
